...
def load_model_weights_safely(model, model_path, map_location='cpu'):
...
def initialize_training(model, best_model_path, learning_rate, weight_decay):
    load_model_weights_safely(model, best_model_path, map_location=device)
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epochs):
        ...
        if loss_exploded:
            ...
            if load_model_weights_safely(model, args.model_path, map_location=device):
                optimizer = initialize_training(model, args.model_path, args.lr, args.weight_decay)
                recent_losses = []
                continue
            else:
